...
<div class="main_sr">
   ...
   <div class="main_content  @if(Request::url() === Request::root().'/umokkur')
   contact_page
@endif
@if(Request::url() === Request::root())
   home_page
@endif
@if(Request::url() === Request::root().'/leiga')
 leiga_page
@endif
@if(Request::url() === Request::root().'/service')
service_page
@endif
">
   ...
   <footer class="footer @if(Request::url() === Request::root().'/umokkur')
   contact_page
@endif">
